...
" Last Change:	2015 Feb 17
" Modified by:  Jack Holborn <jack@lorinas.no-ip.org>
let s:cpo_save = &cpo
set cpo&vim
...
an 20.435	 &Edit.&Configuration\ vimrc	:call <SID>EditVimrc()<CR>
...
if has("toolbar")
  ...
  an icon=/home/jack/.icons/Newaita/actions/22/document-save-all.svg 1.30 ToolBar.SaveAll		:browse confirm wa<CR>
  ...
  an <silent> icon=/home/jack/.icons/Newaita/actions/22/task-new.svg 1.220 ToolBar.LoadSesn	:call <SID>LoadVimSesn()<CR>
  an <silent> icon=/home/jack/.icons/Newaita/actions/22/document-export.svg 1.230 ToolBar.SaveSesn	:call <SID>SaveVimSesn()<CR>
  an   1.240 ToolBar.RunScript		:browse so<CR>

  an 1.245 ToolBar.-sep6-		<Nop>
  an icon=/home/jack/.icons/Newaita/actions/22/run-build-file.svg 1.250 ToolBar.Make			:make<CR>
  an icon=/home/jack/.icons/Newaita/actions/22/filename-discnumber-amarok.svg 1.270 ToolBar.RunCtags		:exe "!" . g:ctags_command<CR>
  an 1.280 ToolBar.TagJump		g<C-]>

  an 1.295 ToolBar.-sep7-		<Nop>
  an 1.300 ToolBar.Help			:help<CR>
  an <silent> icon=/home/jack/.icons/Newaita/actions/22/system-search.svg 1.310 ToolBar.FindHelp	:call <SID>Helpfind()<CR>
